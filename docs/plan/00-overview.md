...
| Surface | Repo | Tracks |
|---|---|---|
| Backend (Fresh/Deno) | `../expressync` | Schema, bearer middleware, device endpoints, event bus additions, APNs publisher |
| Frontend (Fresh/Preact) | `../expressync` | Devices listing, device detail, picker rename, tap-target endpoint |
...
- [`30-backend.md`](30-backend.md) — backend implementation plan (expressync)
- [`40-frontend.md`](40-frontend.md) — frontend implementation plan (expressync)
