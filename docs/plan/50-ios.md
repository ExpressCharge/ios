...
- **Apple Developer Team ID:** `ABC1234XYZ` (paid account; required for NFC capability + push).
- **Full App ID:** `ABC1234XYZ.gg.vlad.expresscan` (used in `apple-app-site-association` `appIDs`).
...
- **Entitlements:**
  ...
  - `com.apple.developer.associated-domains = ["applinks:manage.example.com"]`
