...
//  Networking
//
//  Single generic entry point for HTTP requests against the expressync
...
/// Async/await HTTP client tuned for the expressync API.
public actor APIClient {
    ...
    ///
    /// - Parameters:
    ///   - baseURL: e.g. `URL(string: "https://manage.polaris.express")!`.
