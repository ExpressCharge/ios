...
/// pushing into `SettingsView`. Used by every non-kiosk screen. The
/// brand wordmark used to share this toolbar on the leading side; per
/// user direction it's been removed entirely so the home view's hero
/// stays uncluttered.
