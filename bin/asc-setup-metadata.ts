    ...
    body: JSON.stringify({
      data: {
        ...
        attributes: {
          ...
          notes:
            "Internal/external beta testers will use their existing Polaris account credentials at https://example.com to register the device and an NFC charge card to test the tap-to-start flow.",
        },
      },
    }),
  });
